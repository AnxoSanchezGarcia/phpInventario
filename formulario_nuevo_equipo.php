...
<html>
    ...
    <body>
        <!-- ATENCION AOS PHP QUE HAI NO MEDIO E NOS VALUES, COMPLICADO -->
        ...
        <form action="grabar_nuevo_equipo.php" method="GET">
            ...
            <?php
                /*
                 * Isto só sae se hai erro no nome */
            ...
            <?php
                /*
                 * Isto só sae se hai erro na descrición */
            ...
            <div>RAM <input type="text" name="ram" value="<?php echo $_SESSION['datos'][3]; ?>" /></div>
               <?php
                 ...
                 /*
                 * Isto só sae se hai erro na RAM */
